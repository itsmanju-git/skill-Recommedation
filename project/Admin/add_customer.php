...
?>
      ...
      <div class="form-group">
                    <label for=" Username"> Enter Usrename </label>
      ...
      <div class="form-group">
                    ...
                    <select name="Admin Type" name="admin_type" class="form-control">
      ...
      <script>
        $(document).ready(function(){
          $("#submit").click(function(){
            ...
            var first_name=$("#first_name").var();
            var last_name=$("#last_name").var();
            var admin_type=$("#admin_type").var();
