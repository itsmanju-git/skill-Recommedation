...
?>
        ...
        <nav aria-label="breadcrumb">
          ...
          <h1 class="h2">Update Customers</h1>
              ...
              <div class="btn-group mr-2">
                 ...
                 <!-- <a calss="btn btn-primary" herf="add_customer.php">Add Customers</a> -->
            </div>
          </div>
      ...
      <div class="form-group">
                    ...
                    <input type="text" name="Username" id="Username" value="<?php echo $admin_username; ?>" class="form-control" placeholder="Enter  Username">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
                    ...
                    <select name="Admin Type" name="admin_type" value="<?php echo  $admin_type; ?>" class="form-control"></label>
